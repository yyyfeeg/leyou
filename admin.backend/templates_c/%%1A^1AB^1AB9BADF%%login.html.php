<?php /* Smarty version 2.6.20, created on 2018-03-15 12:16:16
...
<body onload="focusForm();">
    ...
    <form style="margin:0px;" method="post" action="" name="loginform" autocomplete="off" id="loginform" onsubmit=" return doSubmit();">
        ...
        <div class="loginbox bg-white">
            ...
            <div class="loginbox-textbox">
                <img style="margin-left:0" id="code_img" src="./lyinclude/getcode.php" width="50" height="34" alt="点击再刷新换一个" style="background-color: #000000;" onclick="javascript:this.src='./lyinclude/getcode.php?id='+Math.random();">
            </div>
