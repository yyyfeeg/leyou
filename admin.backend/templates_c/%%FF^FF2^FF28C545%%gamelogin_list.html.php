<?php /* Smarty version 2.6.20, created on 2018-02-09 16:43:11
         compiled from gamelogin_list.html */ ?>
...
unset($_smarty_tpl_vars);
 ?>
    <!--  /Loading Container -->
    <!-- Main Container -->
    <?php if ('gamelogin' == $this->_tpl_vars['list']): ?><!--列表-->
    <style>
        ul{
            list-style: none;
        }
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bordered-bottom bordered-yellow">
                        <span class="widget-caption">游戏登录日志</span>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table class="table table-bordered table-hover table-striped table-hover" id="searchable">
                            <thead class="bordered-darkorange">
                                ...
                                <input type='hidden' name="method" value='gamelogin_list'/>
...
"/>
                        ...
                        <thead class="bordered-darkorange">
                        <tr role="row" id="test">
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 80px;text-align: center;" >登录时间</th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 180px;text-align: center;" >IP</th>
                        </tr>
