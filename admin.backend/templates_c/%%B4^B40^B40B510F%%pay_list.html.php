<?php /* Smarty version 2.6.20, created on 2018-03-03 10:19:16
         compiled from pay_list.html */ ?>
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bordered-bottom bordered-yellow">
                        <span class="widget-caption">成功充值订单</span>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table class="table table-bordered table-hover table-striped table-hover" id="searchable">
                            <thead class="bordered-darkorange">
                                ...
                                <input type='hidden' name="method" value='paylist'/>
...
"/>
                                ...
                                <div style="margin-left:10px;float:left;display: none;">账号ID：
                                    <div class="form-group">
...
"/>
                                ...
                                <div style="margin-left:10px;float:left;">玩家角色名：
                                    <div class="form-group">
...
"/>
                        ...
                        <tr role="row" id="test">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 50px;text-align: center;" >游戏服ID</th>
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 120px;text-align: center;" >角色名</th>
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 120px;text-align: center;" >账号</th>
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 120px;text-align: center;" >支付方式</th>
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 180px;text-align: center;" >订单号</th>
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 50px;text-align: center;" >充值金额(元)</th>
                            <th class="sorting" tabindex="0" aria-controls="searchable"  style="width: 50px;text-align: center;" >游戏币数量</th>
                        </tr>
...
' !=''){
        ...
        function btn_export(){
            ...
            location.href="index.php?module=ad_reg&method=paylist&export=1&starttime2="+starttime2+"&endtime2="+endtime2+"&gid="+gid+"&aid="+aid+"&adsons="+adsons+"&tid="+tid+"&mtype="+mtype+"&money="+money+"&uid="+uid+"&uname="+uname+"&orderid="+orderid;
        }
    </script>
