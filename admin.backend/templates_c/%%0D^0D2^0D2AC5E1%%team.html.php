<?php /* Smarty version 2.6.20, created on 2018-01-08 15:10:59
         compiled from team.html */ ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <!-- Main Container -->
     <?php if ('listteam' == $this->_tpl_vars['team']): ?>  <!--团队列表-->
    <style>
        ul{
            list-style: none;
        }
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bordered-bottom bordered-yellow">
                        <span class="widget-caption">团队列表</span>
                        ...
                        <table class="table table-bordered table-hover table-striped table-hover" id="searchable">
                            <thead class="bordered-darkorange">
                                <tr id='foot'>
                                    ...
                                    <th rowspan="1" colspan="1"><input type="text" name="search_browser" placeholder="搜索团队名" class="form-control input-sm"></th>
                                    <th rowspan="1" colspan="1"><input type="text" name="search_platform" placeholder="搜索团队描述" class="form-control input-sm"></th>
...
,
    ...
    <?php if ('addteam' == $this->_tpl_vars['team']): ?> <!--团队添加-->
    <div class="col-lg-12 col-lg-offset-3 col-sm-12 col-xs-12" style="0 auto">
        <h5 class="row-title before-pink"><i class="fa fa-expand pink"></i>团队添加</h5>
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="widget">
                    <div class="widget-header bordered-top bordered-palegreen">
                        <span class="widget-caption">团队添加表单</span>
                    </div>
                    <div class="widget-body">
                        <div class="collapse in">
                            <form enctype="multipart/form-data" action="index.php?module=team&method=addteam" method="post" id='myform' name='myform'>
                                <input name="act" value="addteam" type="hidden">
                                <input name="upload_url" value="<?php echo $this->_tpl_vars['info']; ?>
" type="hidden">
                                <div class="form-group">
                                    <label for="definpu">团队名：</label><span style="color:red">*</span>
                                    <input type="text" class="form-control" id="teamname" name="teamname" placeholder="团队名" value="<?php echo $this->_tpl_vars['data']['ti_teamname']; ?>
" onblur="clean_error('teamname')">
                                </div>
                                <div class="form-group">
                                    <label for="definpu">团队描述：</label><span style="color:red">*</span>
                                    <textarea class="form-control" rows="3" placeholder="团队描述" id='teamdesc' name='teamdesc' onblur="clean_error('teamdesc')"><?php echo $this->_tpl_vars['data']['ti_teamdesc']; ?>
</textarea>
                                </div>
                                <button type="submit" class="btn btn-blue" onclick="return addGameCheck('index.php?module=team&method=addteam','myform',0)">添 加</button>
    ...
    <?php if ('edit' == $this->_tpl_vars['team']): ?> <!--团队修改-->
    <div class="col-lg-12 col-lg-offset-3 col-sm-12 col-xs-12" style="0 auto">
        <h5 class="row-title before-pink"><i class="fa fa-expand pink"></i>团队添加</h5>
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="collapse in">
                            <form enctype="multipart/form-data" action="index.php?module=team&method=edit" method="post" id='myform' name='myform'>
...
" onblur="clean_error('teamname')">
                                ...
                                <button type="submit" class="btn btn-blue" onclick="return addGameCheck('index.php?module=team&method=edit','myform',0)">修 改</button>
                                <button type="submit" onClick="history.go(-1);return false;" value="取消" name="submit" class="btn btn-blue">取 消</button>
                            </form>
                        </div>
                    </div>
