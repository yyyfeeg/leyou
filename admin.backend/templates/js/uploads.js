var nSlice_count = 200,//分段数
    nFactCount,           //实际分段数
    nMin_size      = 10,//最小分段大小(M)
    nMax_size     = 20,  //最大分段大小(M)
    nFactSize,           //实际分段大小
    nCountNum     = 0,  //分段标号
    sFile_type,           //文件类型
...
function startUpload(){
    ...
    var floadend = function(e){
        ...
        window.parent.document.getElementById("name").value=fName;
        window.parent.document.getElementById("size").value=fSize;
        //window.parent.document.getElementById("path").value=fType;
    ...
    var uploadStart = function(){
        ...
        fData.append("module","adsite");
        fData.append("method","parentadd");
        fData.append("flag","up");
        ...
        xhr.open("POST","../index.php");  //后台php路径
        xhr.send(fData);
    };
