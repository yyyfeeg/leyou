<?php /* Smarty version 2.6.20, created on 2017-12-11 15:09:37
...
/templates/mobile/js/jquery.min.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['web_url']; ?>
/templates/mobile/js/jquery.handle.js" type="text/javascript"></script>
    ...
    {
    window.location="m/index_m.html"; //这里的网址请改为你手机站的网址
    }
    }
    }
    catch(err)
...
<div class="wap">
    ...
    <div class="head">
		<!--logo-->
	    <div class="logo">
	        <a href="#" title="欢乐游戏"><img src="<?php echo $this->_tpl_vars['web_url']; ?>
...
/m/index_m.html" title="首页"><span><img src="<?php echo $this->_tpl_vars['web_url']; ?>
/skin0/images/首页.png" style="margin-top: 3px;" /></span><p>首页</p></a></li>
	                <li class="nav_2 "><a href="<?php echo $this->_tpl_vars['web_url']; ?>
/m/news.html" title="新闻"><span><img src="<?php echo $this->_tpl_vars['web_url']; ?>
/skin0/images/新闻.png" style="margin-top: 3px;" /></span><p>新闻</p></a></li>
	                <li class="nav_3 "><a href="" title="礼包"><span><img src="<?php echo $this->_tpl_vars['web_url']; ?>
/skin0/images/礼包.png" style="margin-top: 3px;" /></span><p>礼包</p></a></li>
	                <li class="nav_4 "><a href="<?php echo $this->_tpl_vars['web_url']; ?>
/m/product.html" title="游戏"><span><img src="../skin0/images/游戏.png" style="margin-top: 3px;" /></span><p>游戏</p></a></li>
	                <li class="nav_5 "><a href="" title="用户"><span><img src="<?php echo $this->_tpl_vars['web_url']; ?>
/skin0/images/用户.png" style="margin-top: 3px;" /></span><p>用户</p></a></li>
	                <li class="nav_6 "><a href="" title="客服"><span><img src="<?php echo $this->_tpl_vars['web_url']; ?>
...
" class="hot_logoin" target="_blank">进入官网</a></div>
        ...
        <div class="popular_gifts">
            ...
            <div class="popular_content" >
            	<!-- <div class="popular popular_1">
            		<span>
            			<a href="#"><img src="../skin0/images/tusw.png" width="100%" /></a>
            		</span>
            	...
            	<!-- <div class="popular_more"><a href="#">+更多礼包</a></div> -->
            </div>
        </div>
        <!--热门礼包 end-->
...
/m/index_m.html" title="首页"><span><img style="margin-top: 6px;" src="<?php echo $this->_tpl_vars['web_url']; ?>
/skin0/images/首页.png" /></span><p>首页</p></a></li>
	        <li class="news"><a href="<?php echo $this->_tpl_vars['web_url']; ?>
/m/news.html" title="新闻"><span><img style="margin-top: 6px;" src="<?php echo $this->_tpl_vars['web_url']; ?>
/skin0/images/新闻.png" /></span><p>新闻</p></a></li>
	        <li class="game"><a href="<?php echo $this->_tpl_vars['web_url']; ?>
/m/product.html" title="游戏"><span><img style="margin-top: 6px;" src="<?php echo $this->_tpl_vars['web_url']; ?>
/skin0/images/游戏.png" /></span><p>游戏</p></a></li>
	        <li class="user"><a href="" title="用户"><span><img style="margin-top: 6px;" src="<?php echo $this->_tpl_vars['web_url']; ?>
