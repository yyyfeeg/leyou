...
/skin0/images/首页.png" style="margin-top: 3px;" /></span><p>首页</p></a></li>
                        <li class="nav_2 on"><a href="<?php echo $this->_tpl_vars['web_url']; ?>
...
/m/js/zepto.min.js"></script>
			...
			$(function(){
				...
				function getData(offset,size){
					$.ajax({
						type: 'GET',
						url: '<?php echo $this->_tpl_vars['web_url']; ?>
/html/json/news_list.json'+ '?' + offset + '/' + size, //这里offset,size无作用，仅方便调试
						dataType: 'json',
...
/skin0/images/首页.png" /></span><p>首页</p></a></li>
                <li class="news on"><a href="<?php echo $this->_tpl_vars['web_url']; ?>
